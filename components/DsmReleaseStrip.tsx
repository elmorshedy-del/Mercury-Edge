      ...
      <div style={{ maxWidth: 980, margin: "0 auto" }}>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginBottom: 10 }}>
          <div>
            ...
            <div style={{ marginTop: 3, fontSize: 17, fontWeight: 800, letterSpacing: "-.02em" }}>Official daily max as it updates</div>
          </div>
          <div style={{ fontSize: 9, color: error ? "#ffb4aa" : "#9fb1c1", textAlign: "right" }}>
            {error ? error : "10s dashboard polling · NWS index cached 8s"}
          </div>
        </div>
            ...
            return (
              <article key={station.stid} style={{ flex: "0 0 245px", background: "#14212c", border: "1px solid #304657", borderRadius: 14, padding: 12 }}>
                <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 8 }}>
                  ...
                  <div style={{ fontSize: 9, fontWeight: 800, color: station.error ? "#ffb4aa" : "#a9d2f2", textAlign: "right" }}>
                    {station.error ? "cached / degraded" : "LIVE"}
                  </div>
                </div>
                ...
                <div style={{ marginTop: 12, padding: "10px 11px", background: "#0a1219", borderRadius: 10, border: "1px solid #263c4d" }}>
                  ...
                  <div style={{ marginTop: 6, fontSize: 10, color: "#9fb1c1" }}>
                    High observed {fmtTime(latest?.highObservedAt ?? null, station.timezone)}
                  </div>
                </div>
